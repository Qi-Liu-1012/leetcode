...
public class RunTimeUtils {
    public static Object RunFuncAndTimer(Integer reTime,Object classEnt,String method,Object...objects){
        Object result = new Object();
        try {
            Class<?> entClass;
            if (classEnt instanceof Class<?>) {
                entClass = (Class<?>) classEnt;
            } else {
                entClass = classEnt.getClass();
            }
            Method m = entClass.getDeclaredMethod(method);
            long startTime = System.currentTimeMillis();
            result = m.invoke(classEnt, objects);
